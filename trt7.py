...
class InferThread(threading.Thread):
    def __init__(self, frame_queue : Queue, max_queue_size, yolov7 : YoLov7TRT, video_path):
        ...
        self.yolov7 = yolov7
        self.gs_pipeline = gs_pipeline = "filesrc location={} ! qtdemux ! queue ! h264parse ! omxh264dec ! nvvidconv ! video/x-raw,format=BGRx ! queue ! videoconvert ! queue ! video/x-raw, format=BGR ! appsink".format(video_path)
        self.timer = TimerFps()
...
class DisplayThread(threading.Thread):
    def __init__(self, frame_queue, yolov7 : YoLov7TRT, sort_tracker : SortTracker, tracking : Tracking):
        super().__init__()
        self.frame_queue = frame_queue
        self.yolov7 = yolov7
...
if __name__ == '__main__':
    ...
    max_queue_size = 1  # Maximum size of the frame queue
